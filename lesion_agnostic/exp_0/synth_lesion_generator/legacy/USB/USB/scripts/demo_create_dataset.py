...
def main(args):
    ...
    for path, loader, dataset_type in zip(paths, loaders, ['test']):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_config_path", type=str, default="cfgs/dataset/test/create_test.yaml")
    parser.add_argument("--save_path", type=str, default="assets")
