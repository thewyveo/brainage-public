...
from ..base.constants import MODEL_VAEBASE
from ..base.base_model import BaseModelVAEBASE
from ..base.distributions import Normal

class vaebase(BaseModelVAEBASE):
    r"""
    VAE baseline model based on: https://github.com/StefanDenn3r/Unsupervised_Anomaly_Detection_Brain_MRI/blob/master/mains/main_VAE.py
    """
    ...
    def __init__(
        ...
        super().__init__(model_name=MODEL_VAEBASE,
                        cfg=cfg,
                        input_dim=input_dim,
                        z_dim=z_dim)
