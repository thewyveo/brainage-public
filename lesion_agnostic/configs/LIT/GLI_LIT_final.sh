#!/bin/bash
#SBATCH --job-name=gli_lit
#SBATCH --partition=gpu_h100
#SBATCH --gres=gpu:2
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G
#SBATCH --time=72:00:00
#SBATCH --output=/home/kozdemir/logs/gli_lit_%j.out
#SBATCH --error=/home/kozdemir/logs/gli_lit_%j.err
...
T1_DIR="/home/kozdemir/IXI_GLI_t1"
MASK_DIR="/home/kozdemir/IXI_GLI_masks"
