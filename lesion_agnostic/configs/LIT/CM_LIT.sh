#!/bin/bash
#SBATCH --job-name=cm_lit
#SBATCH --partition=gpu_h100
#SBATCH --gres=gpu:2
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G
#SBATCH --time=72:00:00
#SBATCH --output=/home/kozdemir/logs/cm_lit_%j.out
#SBATCH --error=/home/kozdemir/logs/cm_lit_%j.err
...
T1_DIR="/home/kozdemir/IXI_CM_t1"
MASK_DIR="/home/kozdemir/IXI_CM_masks"
OUTPUT_DIR="/home/kozdemir/CM_LIT"

T1_SUFFIX="_carvemix.nii.gz"
MASK_SUFFIX="_tumor_mask.nii.gz"
