#!/bin/bash
#SBATCH --job-name=lit_gli_continue
#SBATCH --partition=gpu_h100
#SBATCH --gres=gpu:2
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G
#SBATCH --time=24:00:00
#SBATCH --output=/home/kozdemir/logs/lit_gli_continue_%j.out
#SBATCH --error=/home/kozdemir/logs/lit_gli_continue_%j.err
...
T1_DIR="/home/kozdemir/IXI_GLI_RERUN_t1"
MASK_DIR="/home/kozdemir/IXI_GLI_RERUN_masks"
OUTPUT_DIR="/home/kozdemir/GLI_LIT"

T1_SUFFIX="_synthetic_t1.nii.gz"
