#!/bin/bash
#SBATCH --job-name=joos_ixi_prep
#SBATCH --output=/home/kozdemir/logs/joos_ixi_prep_%j.out
#SBATCH --error=/home/kozdemir/logs/joos_ixi_prep_%j.err
...
/home/kozdemir/brainage/lesion_agnostic/exp_0/processing/preprocessing/overall/preprocess.py \
  --profile joos \
  --input-dir /home/kozdemir/IXI-Stripped \
  --output-dir /home/kozdemir/JOOS_IXI_PREP \
