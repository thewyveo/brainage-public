#!/bin/bash
#SBATCH --job-name=joos_gli_prep
#SBATCH --output=/home/kozdemir/logs/joos_gli_prep_%j.out
#SBATCH --error=/home/kozdemir/logs/joos_gli_prep_%j.err
...
/home/kozdemir/brainage/lesion_agnostic/exp_0/processing/preprocessing/overall/preprocess.py \
  --profile joos \
  --input-dir /home/kozdemir/IXI_GLI_t1 \
  --output-dir /home/kozdemir/JOOS_IXI_GLI_PREP \
