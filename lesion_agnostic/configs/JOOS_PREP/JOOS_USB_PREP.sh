#!/bin/bash
#SBATCH --job-name=joos_usb_prep
#SBATCH --output=/home/kozdemir/logs/joos_usb_prep_%j.out
#SBATCH --error=/home/kozdemir/logs/joos_usb_prep_%j.err
...
/home/kozdemir/brainage/lesion_agnostic/exp_0/processing/preprocessing/overall/preprocess.py \
  --profile joos \
  --input-dir /home/kozdemir/IXI_USB_t1 \
  --output-dir /home/kozdemir/JOOS_USB_PREP \
