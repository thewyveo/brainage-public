#!/bin/bash
#SBATCH --job-name=joos_gli_bid_prep
#SBATCH --output=/home/kozdemir/logs/joos_gli_bid_prep_%j.out
#SBATCH --error=/home/kozdemir/logs/joos_gli_bid_prep_%j.err
...
/home/kozdemir/brainage/lesion_agnostic/exp_0/processing/preprocessing/overall/preprocess.py \
  --profile joos \
  --input-dir /home/kozdemir/GLI_BID \
  --output-dir /home/kozdemir/JOOS_GLI_BID_PREP \
