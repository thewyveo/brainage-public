...
#SBATCH --output=/home/kozdemir/synthseg_%j.out
#SBATCH --error=/home/kozdemir/synthseg_%j.err
...
mri_synthseg \
  --i "/home/kozdemir/IXI_CM_rerun/synthetic" \
  --o "/home/kozdemir/CM_synthseg" \
