...
#SBATCH --output=/home/kozdemir/logs/gli_synthseg_%j.out
#SBATCH --error=/home/kozdemir/logs/gli_synthseg_%j.err
...
mri_synthseg \
  --i "/home/kozdemir/IXI_GLI_t1" \
  --o "/home/kozdemir/IXI_GLI_synthseg" \
  --robust
