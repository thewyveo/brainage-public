...
#SBATCH --output=/home/kozdemir/logs/cm_synthseg_%j.out
#SBATCH --error=/home/kozdemir/logs/cm_synthseg_%j.err
...
mri_synthseg \
  --i "/home/kozdemir/IXI_CM_t1" \
  --o "/home/kozdemir/CM_IXI_synthseg" \
  --robust
