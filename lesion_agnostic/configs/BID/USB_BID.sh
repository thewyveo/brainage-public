#!/bin/bash
#SBATCH --job-name=usb_bid
#SBATCH --partition=gpu_a100
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G
#SBATCH --time=24:00:00
#SBATCH --output=/home/kozdemir/logs/usb_bid_%j.out
#SBATCH --error=/home/kozdemir/logs/usb_bid_%j.err
...
INPUT_DIR="/home/kozdemir/USB_IXI_rerun/y_p/mris"
OUTPUT_DIR="/home/kozdemir/USB_BID"
