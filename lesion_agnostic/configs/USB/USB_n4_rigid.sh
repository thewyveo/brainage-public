#!/bin/bash
#SBATCH --job-name=usb_n4_rigid
#SBATCH --output=/home/kozdemir/logs/usb_n4_rigid_%j.out
#SBATCH --error=/home/kozdemir/logs/usb_n4_rigid_%j.err
...
python /home/kozdemir/brainage/lesion_agnostic/exp_0/processing/preprocessing/overall/cm_prep2.py \
  --ixi-img-dir /home/kozdemir/IXI_USB_t1/mris \
  --out-img-dir /home/kozdemir/IXI_USB_n4_rigid \
