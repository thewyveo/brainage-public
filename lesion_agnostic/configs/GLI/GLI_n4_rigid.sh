#!/bin/bash
#SBATCH --job-name=gli_n4_rigid
#SBATCH --output=/home/kozdemir/logs/gli_n4_rigid_%j.out
#SBATCH --error=/home/kozdemir/logs/gli_n4_rigid_%j.err
...
python /home/kozdemir/brainage/lesion_agnostic/exp_0/processing/preprocessing/overall/cm_prep2.py \
  --ixi-img-dir /home/kozdemir/IXI_GLI_RERUN_OUT \
  --out-img-dir /home/kozdemir/IXI_GLI_n4_rigid \
