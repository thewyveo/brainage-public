#!/bin/bash
#SBATCH --job-name=bnx_prep_gli_bid
#SBATCH --output=/home/kozdemir/logs/bnx_prep_gli_bid_%j.out
#SBATCH --error=/home/kozdemir/logs/bnx_prep_gli_bid_%j.err
...
python exp_0/processing/preprocessing/overall/preprocess2.py \
    ...
    --output-dir /home/kozdemir/BNX_GLI_BID_PREP \
