#!/bin/bash
#SBATCH --job-name=bnx_prep
#SBATCH --output=/home/kozdemir/logs/bnx_prep_%j.out
#SBATCH --error=/home/kozdemir/logs/bnx_prep_%j.err
...
python /home/kozdemir/brainage/lesion_agnostic/exp_0/processing/preprocessing/overall/cm_prep2.py \
  --ixi-img-dir /home/kozdemir/IXI_CM_t1 \
  --out-img-dir /home/kozdemir/BNX_CM_PREP \
