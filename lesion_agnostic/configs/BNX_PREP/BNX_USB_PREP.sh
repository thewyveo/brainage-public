#!/bin/bash
#SBATCH --job-name=bnx_usb_prep
#SBATCH --output=/home/kozdemir/logs/bnx_usb_prep_%j.out
#SBATCH --error=/home/kozdemir/logs/bnx_usb_prep_%j.err
...
python exp_0/processing/preprocessing/overall/preprocess2.py \
    --profile custom \
    --input-dir /home/kozdemir/USB_IXI_rerun/y_p \
    --output-dir /home/kozdemir/BNX_USB_PREP \
