#!/bin/bash
#SBATCH --job-name=bnx_gli_usb_prep
#SBATCH --output=/home/kozdemir/logs/bnx_gli_usb_prep_%j.out
#SBATCH --error=/home/kozdemir/logs/bnx_gli_usb_prep_%j.err
...
python exp_0/processing/preprocessing/overall/preprocess2.py \
    ...
    --output-dir /home/kozdemir/BNX_GLI_USB_PREP \
